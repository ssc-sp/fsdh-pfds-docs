...
Cette section explique comment gérer les espaces de travail et les utilisateurs sur la Plateforme fédérale de données scientifiques (PFDS). Vous apprendrez à provisionner des outils, à gérer les utilisateurs et à configurer les paramètres de l'espace de travail.
...
* Inviter des utilisateurs à votre espace de travail: [Inviter un utilisateur](/fr/gerer-espaces-et-utilisateurs/Invitez-un-utilisateur)
...
* Gérer votre BOI et les budgets de votre espace de travail: [Gestion du BOI](/fr/gerer-espaces-et-utilisateurs/Gestion-BOI)