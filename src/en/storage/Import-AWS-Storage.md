...
![IAM in service menu](./img/import_aws-01.png)

2. In the **Users** section, create a new user.  
![Users section](./img/import_aws-02.png)
![Create user](./img/import_aws-03.png)
![Assign user name](./img/import_aws-04.png)
...
![Assign policy](./img/import_aws-05.png)  
```
{
    "Version": "2012-10-17",
    "Statement": [
...
![Review and create](./img/import_aws-06.png)
...
![Find user in list](./img/import_aws-07.png)
![Create access key](./img/import_aws-08.png)
...
![Access key use case](./img/import_aws-09.png)
![Key description](./img/import_aws-10.png)
