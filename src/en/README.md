...
* Setting up and managing workspaces and users
* Using storage containers with FSDH, including bring-your-own storage options
* Working with Azure Databricks for data processing and analysis
