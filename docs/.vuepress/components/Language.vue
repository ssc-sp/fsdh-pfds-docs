  ...
  computed: {
    ...
    langToggleHref() {
      const mappings = [
        ...
        {"en": '/en/storage/Import-Azure-Storage', "fr": '/fr/stockage/Importer-Azure-Storage'},
        ...
        {"en": '/en/databricks/Git-Integration', "fr": '/fr/databricks/Integration-de-Git'},
        ...
        {"en": '/en/databricks/Connecting-Google-API', "fr": '/fr/databricks/Connexion-a-lAPI-Google'},
        ...
        {"en": '/en/postgresql/psql-databricks-comparison', "fr": '/fr/postgresql/Comparaison-des-bases-de-donnees-psql'},
