...
![Pick an account](./img/pick-an-account.png)
...
![Just a moment](./img/wait-for-prompt.png)

1. Click `Next`
![More information required](./img/click-next.png)
...
![Password entry](./img/password-entry.png)
...
![Terms and Conditions](./img/terms-and-conditions.png)
