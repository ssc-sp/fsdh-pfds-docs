...
This is where you get your SAS URL. Remember, <u>unless someone has provided you with a longer term URL, this URL will expire in *30* minutes</u> (To get a long term URL, submit a support request to the FSDH team). Refresh the page when you want a new 30 minute URL.
...
Now let's try to access these files from your web application. For this we will have to import the pandas library and read the SAS URL from the environment variables. 
