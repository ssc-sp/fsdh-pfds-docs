...
> Note: Whenever you run `pip install` on your local system, you should add that package name to this list. This tells your server environment what to install during build time. You can use `pip freeze > requirements.txt` to automatically add all local libraries to the `requirements.txt` file.
...
<gcds-details details-title="This is the YAML file for the workflow.">
