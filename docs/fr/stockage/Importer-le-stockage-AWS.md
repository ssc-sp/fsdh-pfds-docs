...
![IAM dans le menu de service](./img/import_aws-01.png)

2. Dans la section **Utilisateurs**, créez un nouvel utilisateur.  
![Section utilisateurs](./img/import_aws-02.png)
![Créer un utilisateur](./img/import_aws-03.png)
![Attribuer un nom d'utilisateur](./img/import_aws-04.png)
...
![Politique d'affectation](./img/import_aws-05.png)
```
{
    "Version" : "2012-10-17",
    "Déclaration" : [
...
![Réviser et créer](./img/import_aws-06.png)
...
![Trouver un utilisateur dans la liste](./img/import_aws-07.png)
![Créer une clé d'accès](./img/import_aws-08.png)
...
![Cas d'utilisation de la clé d'accès](./img/import_aws-09.png)
![Description de la clé](./img/import_aws-10.png)
...
![Clé d'accès](./img/import_aws-11.png)
...
![Dialogue de configuration AWS](./img/import_aws-12.png)
