...
![Comptes de service dans le menu](./img/import_gcp-01.png)
...
![Bouton de création de compte](./img/import_gcp-02.png)
![Détails du compte de service](./img/import_gcp-03.png)
...
![Page utilisateur du compte de service](./img/import_gcp-04.png)
![Boîte de dialogue Créer une clé privée](./img/import_gcp-05.png)
...
![Dialogue d'importation du stockage des BPC](./img/import_gcp-06.png)