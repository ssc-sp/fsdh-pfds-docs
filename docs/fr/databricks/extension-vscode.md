...
![Extension Databricks](./img/vscode_databricks_1.png)
...
![Extension Databricks](./img/vscode_databricks_2.png)
...
![Extension Databricks](./img/vscode_databricks_3.png)
...
![Extension Databricks](./img/vscode_databricks_4.png)
...
![Extension Databricks](./img/vscode_databricks_5.png)
1. Le fichier sera exécuté sur le cluster. Vous pouvez voir les résultats dans la fenêtre **Sortie**.
![Extension Databricks](./img/vscode_databricks_6.png)
